...
print("authenticate:")
printRespo( transmit(conn,[0xFF, 0x86, 0x00, 0x00, 0x05, 0x01, 0x00, 0x00, 0x60, 0x01]))

# update Binary Blocks
print("update Binary Blocks:") #TODO warum geht update nicht? -> mit obsolet Version von authenticate probieren...
printRespo( transmit(conn,[0xFF, 0xD6, 0x00, 0x00, 0x10, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F]))

#read Binary Blocks
print("read Binary Blocks:")
printRespo( transmit(conn, [0xFF, 0xB0, 0x00, 0x00, 0x10]))