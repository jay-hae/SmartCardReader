...
print("ATR: " + atr)
printRespo( transmit(conn,[0xFF, 0xCA, 0x00, 0x00, 0x04])) # get serial number of connected PICC
...
print("load authentication data: ")
printRespo( transmit(conn,[0xFF, 0x82, 0x00, 0x00, 0x06, 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF]))

block_nr = 0x01 #block nr >= 0x01
# authenticate (nicht obsolet version)
#BlockNr: 0x04 KeyType: 0x60 KeyNr:0x00
print("authenticate:")
printRespo( transmit(conn,[0xFF, 0x86, 0x00, 0x00, 0x05, 0x01, 0x00, block_nr, 0x60, 0x01]))

"""
# authenticate (obsolet version)
#BlockNr: 0x00 KeyType: 0x60 KeyNr:0x00
print("authenticate obsolet:")
printRespo( transmit(conn,[0xFF, 0x88, 0x00, 0x00, 0x60, 0x00]))
"""
"""
# authenticate (API Ref P. 15 Example 1)
#BlockNr: 0x00 KeyType: 0x60 KeyNr:0x00
print("authenticate:")
printRespo( transmit(conn,[0xFF, 0x88, 0x00, 0x00, 0x60, 0x00]))
"""
# update Binary Blocks
print("update Binary Blocks:") #warum geht update nicht? -> mit obsolet Version von authenticate probieren -> geht auch nicht...; geht mit blocknr. 0x04 und nicht obsolet version
printRespo( transmit(conn,[0xFF, 0xD6, 0x00, block_nr, 0x10, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F]))

#read Binary Blocks
print("read Binary Blocks:")
printRespo( transmit(conn, [0xFF, 0xB0, 0x00, block_nr, 0x10]))